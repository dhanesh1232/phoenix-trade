          ...
          <div className="grid gap-10 md:grid-cols-[3fr,2fr] md:items-start">
            <div className="space-y-4">
              ...
              <p className="text-base md:text-lg leading-relaxed text-muted-foreground pl-3 border-l-2 border-primary">
                Phoenix International Trading is a specialist export company for
                fresh agricultural produce, premium marine goods, and
          ...
          <div className="grid gap-12 md:grid-cols-2">
            <div className="space-y-3">
              ...
              <p className="text-base leading-relaxed text-muted-foreground pl-3 border-l-2 border-primary">
                ...
                sourced fresh and processed food products, known for consistent
        ...
        <div className="mx-auto max-w-5xl px-4 space-y-10">
          <div className="space-y-2">
            ...
            <p className="text-sm md:text-base text-muted-foreground max-w-3xl">
              Phoenix is structured around a simple principle: source correctly,
              document precisely, and deliver reliably. Each pillar of the
              operation is designed for export buyers.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-base text-muted-foreground list-decimal pl-4">
              ...
              <li>Transparent, relationship‑driven approach to global trade</li>
            </ul>
          </div>
        </div>
      </section>
