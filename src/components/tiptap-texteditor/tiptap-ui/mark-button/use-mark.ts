...
// --- Icons ---
import { BoldIcon } from "@/components/tiptap-texteditor/tiptap-icons/bold-icon";
import { Code2Icon } from "@/components/tiptap-texteditor/tiptap-icons/code2-icon";
import { ItalicIcon } from "@/components/tiptap-texteditor/tiptap-icons/italic-icon";
import { StrikeIcon } from "@/components/tiptap-texteditor/tiptap-icons/strike-icon";
import { SubscriptIcon } from "@/components/tiptap-texteditor/tiptap-icons/subscript-icon";
import { SuperscriptIcon } from "@/components/tiptap-texteditor/tiptap-icons/superscript-icon";
import { UnderlineIcon } from "@/components/tiptap-texteditor/tiptap-icons/underline-icon";
