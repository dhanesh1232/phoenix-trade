...
// --- Icons ---
import { HeadingOneIcon } from "@/components/tiptap-texteditor/tiptap-icons/heading-one-icon";
import { HeadingTwoIcon } from "@/components/tiptap-texteditor/tiptap-icons/heading-two-icon";
import { HeadingThreeIcon } from "@/components/tiptap-texteditor/tiptap-icons/heading-three-icon";
import { HeadingFourIcon } from "@/components/tiptap-texteditor/tiptap-icons/heading-four-icon";
import { HeadingFiveIcon } from "@/components/tiptap-texteditor/tiptap-icons/heading-five-icon";
import { HeadingSixIcon } from "@/components/tiptap-texteditor/tiptap-icons/heading-six-icon";
