...
// --- Icons ---
import { CornerDownLeftIcon } from "@/components/tiptap-texteditor/tiptap-icons/corner-down-left-icon";
import { ExternalLinkIcon } from "@/components/tiptap-texteditor/tiptap-icons/external-link-icon";
import { LinkIcon } from "@/components/tiptap-texteditor/tiptap-icons/link-icon";
import { TrashIcon } from "@/components/tiptap-texteditor/tiptap-icons/trash-icon";

// --- Tiptap UI ---
import type { UseLinkPopoverConfig } from "@/components/tiptap-texteditor/tiptap-ui/link-popover";
import { useLinkPopover } from "@/components/tiptap-texteditor/tiptap-ui/link-popover";
...
import { Separator } from "@/components/tiptap-texteditor/tiptap-ui-primitive/separator";
import {
  Input,
  InputGroup,
} from "@/components/tiptap-texteditor/tiptap-ui-primitive/input";
  ...
  (
    ...
    return (
      <Popover open={isOpen} onOpenChange={handleOnOpenChange}>
        ...
        <PopoverContent className="p-1.5" align="end">
          <LinkMain
            url={url}
            setUrl={setUrl}
